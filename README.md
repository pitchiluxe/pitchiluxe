...
| [🖥️ IT / IAM / Help Desk Lab](https://github.com/pitchiluxe/IT_IAM_HelpDesk_Big_Labs) | ![In progress](https://img.shields.io/badge/-in%20progress-9e9e9e?style=flat-square) | A downloadable Windows 11-style desktop training environment with three integrated labs — local user/NTFS management, Entra ID MFA troubleshooting, and a ServiceNow-style ticketing console — plus an Ollama-powered AI Lab Assistant chatbot, Active Directory administration, and a landing page with installer |
| [🌐 CompTIA Security+ / Network+ 3D Lab](https://github.com/pitchiluxe/CompTIA-SecurityPlus-Zero-to-Hero-3D-Lab) | ![In progress](https://img.shields.io/badge/-in%20progress-9e9e9e?style=flat-square) | Interactive Security+ and Network+ training platform — 28 phases, 3D labs, safe simulations, animated landing page, and career-ready portfolio |
| [📡 CCNA Zero-to-Hero 3D Lab](https://github.com/pitchiluxe/CCNA_Zero_to_Hero_3D_Lab_Project) | ![In progress](https://img.shields.io/badge/-in%20progress-9e9e9e?style=flat-square) | Interactive CCNA training platform — 29 phases, live 3D network topologies, Cisco IOS CLI simulator, subnetting, OSPF, VLANs, ACLs, NAT, DHCP, DNS, packet flow, landing page, contact page, and career-ready portfolio |
